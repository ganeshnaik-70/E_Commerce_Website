...
if (isset($_POST['submitpay'])) {
  $item_no = $_SESSION['i_no'];
  $price = $_SESSION['price'];
  $mode = $_POST['mode'];
  $username = $_SESSION['fname'];
  $pass = $_SESSION['password'];
  $que = "INSERT INTO `payment`(`itemno`, `amount`, `p_mode`, `username`, `password`) VALUES ('$item_no','$price','$mode','$username','$pass')";
    ...
    <div class="container">
      <form method="POST" action="payment.php">
        ...
        <div class="row">
          <div class="col-50">
            <h3>Total Amount</h3>
            <h4 class="amount"><?php echo $_SESSION['price']?> $</h4>
